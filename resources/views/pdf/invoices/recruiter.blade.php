@php
    ...
    $brandIcon = 'data:image/svg+xml;base64,'.base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34"><rect width="34" height="34" rx="10" fill="#137FEC"/><path fill="#ffffff" d="M13.1 17.1c2.2 0 3.9-1.7 3.9-3.9 0 2.2 1.7 3.9 3.9 3.9-2.2 0-3.9 1.7-3.9 3.9 0-2.2-1.7-3.9-3.9-3.9zm8.3-7.1c1.3 0 2.4-1 2.4-2.3 0 1.3 1 2.3 2.3 2.3-1.3 0-2.3 1-2.3 2.4 0-1.3-1-2.4-2.4-2.4zm-10.4 2.6c1.3 0 2.4-1 2.4-2.4 0 1.3 1 2.4 2.4 2.4-1.3 0-2.4 1-2.4 2.3 0-1.3-1-2.3-2.4-2.3z"/></svg>');
            ...
            <tr>
                <td style="width: 54%;">
                    <div class="brand-row">
                        ...
                        <span class="brand-name">Resumist</span>
                    </div>
                    <div class="company">
                        <strong>Resumist</strong>
                        <div>AI-powered recruiting platform</div>
                        <div>support@resumist.io</div>
                        <div>www.resumist.io</div>
                    </div>
                </td>
        ...
        <table class="footer-table">
            <tr>
                <td class="footer-copy">
                    Precision Engineered Logic. Generated via Resumist AI Infrastructure.
                </td>
